...
class BaseFileHelper
{
     ...
     * and language code "zh-CN-CN", the localized file will be looked for as
     * "path/to/zh-CN-CN/view.php". If the file is not found, it will try a fallback with just a language code that is
     * "zh-CN" i.e. "path/to/zh-CN/view.php". If it is not found as well the original file will be returned.
     *
